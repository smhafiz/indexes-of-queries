...
{
    cout << "__device__ __forceinline__ void normalize(const uint" << BITS_IN(limbs) << " & aLo, const uint" << BITS_IN(limbs) << " & aHi, const uint2X<uint" << BITS_IN(limbs) << "> & s)\n";//TODO::Check
    cout << "{\n";
    cout << "    uint * _aLo = (uint *)&aLo;\n";
    cout << "    uint * _aHi = (uint *)&aHi;\n";
    ...
    printf("\t//%3s-=(%3s+c)\n", &(*r0='r'), &(*r2='r'));
    cout << "\t: \"+r\"(_aLo[0])";
    for (int i = 1; i <  limbs; i++) cout << ", \"+r\"(_aLo[" << i << "])";
    for (int i = 0; i <  limbs; i++) cout << ", \"+r\"(_aHi[" << i << "])";
    cout << "\n\t: \"r\"(_s[0])";
...
{
    cout << "__device__ __forceinline__ void sub(const uint" << BITS_IN(limbs) << " & aLo, const uint & aHi, const uintXp<uint" << BITS_IN(limbs) << "> & r)\n";
    cout << "{\n";
    cout << "    uint * _aLo = (uint *)&aLo;\n";
    cout << "    uint * _aHi = (uint *)&aHi;\n";
...
static void print_mad(uint limbs)
{
    ...
    cout << "__device__ __forceinline__ void mad(const uint" << BITS_IN(limbs) << " & aLo, const uint" << BITS_IN(limbs) << " & aHi, uint & overflow, const uint" << BITS_IN(limbs) << " & b, const uint" << BITS_IN(limbs) << " & c)\n";
    cout << "{\n";
    cout << "    uint * _aLo = (uint *)&aLo;\n";
    cout << "    uint * _aHi = (uint *)&aHi;\n";
    ...
    cout << ": ";
    for (int i = 0; i < limbs; ++i) cout << "\"+r\"(_aLo[" << i << "]), ";
    for (int i = 0; i < limbs; ++i) cout << "\"+r\"(_aHi[" << i << "]), ";
    cout << "\"+r\"(overflow)\n\t: \"r\"(_b[0])";
...
inline void print_get_q(int limbs)
{
    ...
    cout << "__device__ __forceinline__ uintXp<uint" << BITS_IN(limbs-1) << "> get_q(const uint & aLo, const uint" << BITS_IN(limbs-1) << " & aHi, const uint" << BITS_IN(limbs-1) << " & mu)\n";
    cout << "{\n";
    ...
    cout << "\n\t: \"r\"(_aLo[0])";
    for (int i = 0; i < limbs-1; i++) printf(", \"r\"(_aHi[%u])", i);
