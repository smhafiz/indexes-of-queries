...
__device__ __forceinline__ uintXp<uint256> get_q(const uint & aLo, const uint256 & aHi, const uint256 & mu)
{
    ...
    uint * _aHi = (uint *)&aHi;
    uint * _mu = (uint *)&mu;
    asm("mul.hi.u32     %0, %12, %21;\n\t"		//(O0 = r12  * s21.hi)
"mad.lo.cc.u32	%0, %13, %21, %0;\n\t"		//(O0 += r13 * s21.lo)
"madc.hi.u32	%1, %13, %21, 0;\n\t"		//(O1 = r13 * s21.hi + c  )

"mad.lo.cc.u32	%0, %12, %22, %0;\n\t"		//(O0 += r12 * s22.lo)
"madc.hi.cc.u32	%1, %12, %22, %1;\n\t"		//(O1 += r12 * s22.hi + c  )
"madc.lo.u32	%2, %15, %21, 0;\n\t"		//(O2 = r15 * s21.lo + c  )

"mad.lo.cc.u32	%1, %14, %21, %1;\n\t"		//(O1 += r14 * s21.lo)
"madc.hi.cc.u32	%2, %14, %21, %2;\n\t"		//(O2 += r14 * s21.hi + c  )
"madc.lo.u32	%3, %16, %21, 0;\n\t"		//(O3 = r16 * s21.lo + c  )

"mad.lo.cc.u32	%1, %13, %22, %1;\n\t"		//(O1 += r13 * s22.lo)
"madc.hi.cc.u32	%2, %13, %22, %2;\n\t"		//(O2 += r13 * s22.hi + c  )
"madc.lo.cc.u32	%3, %15, %22, %3;\n\t"		//(O3 += r15 * s22.lo + c  )
"madc.hi.u32	%4, %16, %21, 0;\n\t"		//(O4 = r16 * s21.hi + c  )

"mad.lo.cc.u32	%1, %12, %23, %1;\n\t"		//(O1 += r12 * s23.lo)
"madc.hi.cc.u32	%2, %12, %23, %2;\n\t"		//(O2 += r12 * s23.hi + c  )
"madc.lo.cc.u32	%3, %14, %23, %3;\n\t"		//(O3 += r14 * s23.lo + c  )
"madc.hi.cc.u32	%4, %15, %22, %4;\n\t"		//(O4 += r15 * s22.hi + c  )
"madc.lo.u32	%5, %18, %21, 0;\n\t"		//(O5 = r18 * s21.lo + c  )

"mad.lo.cc.u32	%2, %14, %22, %2;\n\t"		//(O2 += r14 * s22.lo)
"madc.hi.cc.u32	%3, %15, %21, %3;\n\t"		//(O3 += r15 * s21.hi + c  )
"madc.lo.cc.u32	%4, %17, %21, %4;\n\t"		//(O4 += r17 * s21.lo + c  )
"madc.hi.cc.u32	%5, %17, %21, %5;\n\t"		//(O5 += r17 * s21.hi + c  )
"madc.lo.u32	%6, %19, %21, 0;\n\t"		//(O6 = r19 * s21.lo + c  )

"mad.lo.cc.u32	%2, %13, %23, %2;\n\t"		//(O2 += r13 * s23.lo)
"madc.hi.cc.u32	%3, %14, %22, %3;\n\t"		//(O3 += r14 * s22.hi + c  )
"madc.lo.cc.u32	%4, %16, %22, %4;\n\t"		//(O4 += r16 * s22.lo + c  )
"madc.hi.cc.u32	%5, %16, %22, %5;\n\t"		//(O5 += r16 * s22.hi + c  )
"madc.lo.cc.u32	%6, %18, %22, %6;\n\t"		//(O6 += r18 * s22.lo + c  )
"madc.hi.u32	%7, %19, %21, 0;\n\t"		//(O7 = r19 * s21.hi + c  )

"mad.lo.cc.u32	%2, %12, %24, %2;\n\t"		//(O2 += r12 * s24.lo)
"madc.hi.cc.u32	%3, %13, %23, %3;\n\t"		//(O3 += r13 * s23.hi + c  )
"madc.lo.cc.u32	%4, %15, %23, %4;\n\t"		//(O4 += r15 * s23.lo + c  )
"madc.hi.cc.u32	%5, %15, %23, %5;\n\t"		//(O5 += r15 * s23.hi + c  )
"madc.lo.cc.u32	%6, %17, %23, %6;\n\t"		//(O6 += r17 * s23.lo + c  )
"madc.hi.cc.u32	%7, %18, %22, %7;\n\t"		//(O7 += r18 * s22.hi + c  )
"madc.lo.u32	%8, %20, %22, 0;\n\t"		//(O8 = r20 * s22.lo + c  )

"mad.lo.cc.u32	%3, %13, %24, %3;\n\t"		//(O3 += r13 * s24.lo)
"madc.hi.cc.u32	%4, %14, %23, %4;\n\t"		//(O4 += r14 * s23.hi + c  )
"madc.lo.cc.u32	%5, %17, %22, %5;\n\t"		//(O5 += r17 * s22.lo + c  )
"madc.hi.cc.u32	%6, %18, %21, %6;\n\t"		//(O6 += r18 * s21.hi + c  )
"madc.lo.cc.u32	%7, %20, %21, %7;\n\t"		//(O7 += r20 * s21.lo + c  )
"madc.hi.cc.u32	%8, %20, %21, %8;\n\t"		//(O8 += r20 * s21.hi + c  )
"madc.lo.u32	%9, %20, %23, 0;\n\t"		//(O9 = r20 * s23.lo + c  )

"mad.lo.cc.u32	%3, %12, %25, %3;\n\t"		//(O3 += r12 * s25.lo)
"madc.hi.cc.u32	%4, %13, %24, %4;\n\t"		//(O4 += r13 * s24.hi + c  )
"madc.lo.cc.u32	%5, %16, %23, %5;\n\t"		//(O5 += r16 * s23.lo + c  )
"madc.hi.cc.u32	%6, %17, %22, %6;\n\t"		//(O6 += r17 * s22.hi + c  )
"madc.lo.cc.u32	%7, %19, %22, %7;\n\t"		//(O7 += r19 * s22.lo + c  )
"madc.hi.cc.u32	%8, %19, %22, %8;\n\t"		//(O8 += r19 * s22.hi + c  )
"madc.lo.cc.u32	%9, %19, %24, %9;\n\t"		//(O9 += r19 * s24.lo + c  )
"madc.hi.u32	%10, %20, %23, 0;\n\t"		//(O10 = r20 * s23.hi + c  )

"mad.lo.cc.u32	%4, %14, %24, %4;\n\t"		//(O4 += r14 * s24.lo)
"madc.hi.cc.u32	%5, %14, %24, %5;\n\t"		//(O5 += r14 * s24.hi + c  )
"madc.lo.cc.u32	%6, %16, %24, %6;\n\t"		//(O6 += r16 * s24.lo + c  )
"madc.hi.cc.u32	%7, %17, %23, %7;\n\t"		//(O7 += r17 * s23.hi + c  )
"madc.lo.cc.u32	%8, %19, %23, %8;\n\t"		//(O8 += r19 * s23.lo + c  )
"madc.hi.cc.u32	%9, %20, %22, %9;\n\t"		//(O9 += r20 * s22.hi + c  )
"madc.lo.cc.u32	%10, %20, %24, %10;\n\t"		//(O10 += r20 * s24.lo + c  )
"madc.hi.u32	%11, %20, %24, 0;\n\t"		//(O11 = r20 * s24.hi + c  )

"mad.lo.cc.u32	%4, %13, %25, %4;\n\t"		//(O4 += r13 * s25.lo)
"madc.hi.cc.u32	%5, %13, %25, %5;\n\t"		//(O5 += r13 * s25.hi + c  )
"madc.lo.cc.u32	%6, %15, %25, %6;\n\t"		//(O6 += r15 * s25.lo + c  )
"madc.hi.cc.u32	%7, %16, %24, %7;\n\t"		//(O7 += r16 * s24.hi + c  )
"madc.lo.cc.u32	%8, %18, %24, %8;\n\t"		//(O8 += r18 * s24.lo + c  )
"madc.hi.cc.u32	%9, %19, %23, %9;\n\t"		//(O9 += r19 * s23.hi + c  )
"madc.lo.cc.u32	%10, %19, %25, %10;\n\t"		//(O10 += r19 * s25.lo + c  )
"madc.hi.cc.u32	%11, %19, %25, %11;\n\t"		//(O11 += r19 * s25.hi + c  )
"madc.lo.u32	%0, %20, %26, 0;\n\t"		//(O0 = r20 * s26.lo + c  )

"mad.lo.cc.u32	%4, %12, %26, %4;\n\t"		//(O4 += r12 * s26.lo)
"madc.hi.cc.u32	%5, %12, %26, %5;\n\t"		//(O5 += r12 * s26.hi + c  )
"madc.lo.cc.u32	%6, %14, %26, %6;\n\t"		//(O6 += r14 * s26.lo + c  )
"madc.hi.cc.u32	%7, %15, %25, %7;\n\t"		//(O7 += r15 * s25.hi + c  )
"madc.lo.cc.u32	%8, %17, %25, %8;\n\t"		//(O8 += r17 * s25.lo + c  )
"madc.hi.cc.u32	%9, %18, %24, %9;\n\t"		//(O9 += r18 * s24.hi + c  )
"madc.lo.cc.u32	%10, %18, %26, %10;\n\t"		//(O10 += r18 * s26.lo + c  )
"madc.hi.cc.u32	%11, %18, %26, %11;\n\t"		//(O11 += r18 * s26.hi + c  )
"madc.lo.cc.u32	%0, %19, %27, %0;\n\t"		//(O0 += r19 * s27.lo + c  )
"madc.hi.u32	%1, %20, %26, 0;\n\t"		//(O1 = r20 * s26.hi + c  )

"mad.lo.cc.u32	%5, %15, %24, %5;\n\t"		//(O5 += r15 * s24.lo)
"madc.hi.cc.u32	%6, %16, %23, %6;\n\t"		//(O6 += r16 * s23.hi + c  )
"madc.lo.cc.u32	%7, %18, %23, %7;\n\t"		//(O7 += r18 * s23.lo + c  )
"madc.hi.cc.u32	%8, %18, %23, %8;\n\t"		//(O8 += r18 * s23.hi + c  )
"madc.lo.cc.u32	%9, %18, %25, %9;\n\t"		//(O9 += r18 * s25.lo + c  )
"madc.hi.cc.u32	%10, %19, %24, %10;\n\t"		//(O10 += r19 * s24.hi + c  )
"madc.lo.cc.u32	%11, %20, %25, %11;\n\t"		//(O11 += r20 * s25.lo + c  )
"madc.hi.cc.u32	%0, %20, %25, %0;\n\t"		//(O0 += r20 * s25.hi + c  )
"madc.lo.cc.u32	%1, %20, %27, %1;\n\t"		//(O1 += r20 * s27.lo + c  )
"madc.hi.u32	%2, %20, %27, 0;\n\t"		//(O2 = r20 * s27.hi + c  )

"mad.lo.cc.u32	%5, %14, %25, %5;\n\t"		//(O5 += r14 * s25.lo)
"madc.hi.cc.u32	%6, %15, %24, %6;\n\t"		//(O6 += r15 * s24.hi + c  )
"madc.lo.cc.u32	%7, %17, %24, %7;\n\t"		//(O7 += r17 * s24.lo + c  )
"madc.hi.cc.u32	%8, %17, %24, %8;\n\t"		//(O8 += r17 * s24.hi + c  )
"madc.lo.cc.u32	%9, %17, %26, %9;\n\t"		//(O9 += r17 * s26.lo + c  )
"madc.hi.cc.u32	%10, %18, %25, %10;\n\t"		//(O10 += r18 * s25.hi + c  )
"madc.lo.cc.u32	%11, %19, %26, %11;\n\t"		//(O11 += r19 * s26.lo + c  )
"madc.hi.cc.u32	%0, %19, %26, %0;\n\t"		//(O0 += r19 * s26.hi + c  )
"madc.lo.cc.u32	%1, %19, %28, %1;\n\t"		//(O1 += r19 * s28.lo + c  )
"madc.hi.cc.u32	%2, %19, %28, %2;\n\t"		//(O2 += r19 * s28.hi + c  )
"addc.u32	%3, %20, 0;\n\t"		//(O3 = r20 + c  )

"mad.lo.cc.u32	%5, %13, %26, %5;\n\t"		//(O5 += r13 * s26.lo)
"madc.hi.cc.u32	%6, %14, %25, %6;\n\t"		//(O6 += r14 * s25.hi + c  )
"madc.lo.cc.u32	%7, %16, %25, %7;\n\t"		//(O7 += r16 * s25.lo + c  )
"madc.hi.cc.u32	%8, %16, %25, %8;\n\t"		//(O8 += r16 * s25.hi + c  )
"madc.lo.cc.u32	%9, %16, %27, %9;\n\t"		//(O9 += r16 * s27.lo + c  )
"madc.hi.cc.u32	%10, %17, %26, %10;\n\t"		//(O10 += r17 * s26.hi + c  )
"madc.lo.cc.u32	%11, %18, %27, %11;\n\t"		//(O11 += r18 * s27.lo + c  )
...
"mad.lo.cc.u32	%5, %12, %27, %5;\n\t"		//(O5 += r12 * s27.lo)
"madc.hi.cc.u32	%6, %13, %26, %6;\n\t"		//(O6 += r13 * s26.hi + c  )
"madc.lo.cc.u32	%7, %15, %26, %7;\n\t"		//(O7 += r15 * s26.lo + c  )
"madc.hi.cc.u32	%8, %15, %26, %8;\n\t"		//(O8 += r15 * s26.hi + c  )
"madc.lo.cc.u32	%9, %15, %28, %9;\n\t"		//(O9 += r15 * s28.lo + c  )
"madc.hi.cc.u32	%10, %16, %27, %10;\n\t"		//(O10 += r16 * s27.hi + c  )
"madc.lo.cc.u32	%11, %17, %28, %11;\n\t"		//(O11 += r17 * s28.lo + c  )
...
"mad.lo.cc.u32	%6, %13, %27, %6;\n\t"		//(O6 += r13 * s27.lo)
"madc.hi.cc.u32	%7, %14, %26, %7;\n\t"		//(O7 += r14 * s26.hi + c  )
"madc.lo.cc.u32	%8, %16, %26, %8;\n\t"		//(O8 += r16 * s26.lo + c  )
"madc.hi.cc.u32	%9, %17, %25, %9;\n\t"		//(O9 += r17 * s25.hi + c  )
"madc.lo.cc.u32	%10, %17, %27, %10;\n\t"		//(O10 += r17 * s27.lo + c  )
"madc.hi.cc.u32	%11, %17, %27, %11;\n\t"		//(O11 += r17 * s27.hi + c  )
...
"mad.lo.cc.u32	%6, %12, %28, %6;\n\t"		//(O6 += r12 * s28.lo)
"madc.hi.cc.u32	%7, %13, %27, %7;\n\t"		//(O7 += r13 * s27.hi + c  )
"madc.lo.cc.u32	%8, %15, %27, %8;\n\t"		//(O8 += r15 * s27.lo + c  )
"madc.hi.cc.u32	%9, %16, %26, %9;\n\t"		//(O9 += r16 * s26.hi + c  )
"madc.lo.cc.u32	%10, %16, %28, %10;\n\t"		//(O10 += r16 * s28.lo + c  )
"madc.hi.cc.u32	%11, %16, %28, %11;\n\t"		//(O11 += r16 * s28.hi + c  )
"addc.cc.u32	%0, %17, %0;\n\t"		//(O0 += r17 + c)
"addc.cc.u32	%1, 0, %1;\n\t"		//(O1  + = +c)
"addc.cc.u32	%2, 0, %2;\n\t"		//(O2  + = +c)
"addc.cc.u32	%3, 0, %3;\n\t"		//(O3  + = +c)
...
"mad.lo.cc.u32	%7, %14, %27, %7;\n\t"		//(O7 += r14 * s27.lo)
"madc.hi.cc.u32	%8, %14, %27, %8;\n\t"		//(O8 += r14 * s27.hi + c  )
"addc.cc.u32	%9, %14, %9;\n\t"		//(O9 += r14 + c)
"madc.hi.cc.u32	%10, %15, %28, %10;\n\t"		//(O10 += r15 * s28.hi + c  )
"addc.cc.u32	%11, %16, %11;\n\t"		//(O11 += r16 + c)
"addc.cc.u32	%0, 0, %0;\n\t"		//(O0  + = +c)
"addc.cc.u32	%1, 0, %1;\n\t"		//(O1  + = +c)
"addc.cc.u32	%2, 0, %2;\n\t"		//(O2  + = +c)
"addc.cc.u32	%3, 0, %3;\n\t"		//(O3  + = +c)
...
"mad.lo.cc.u32	%7, %13, %28, %7;\n\t"		//(O7 += r13 * s28.lo)
"madc.hi.cc.u32	%8, %13, %28, %8;\n\t"		//(O8 += r13 * s28.hi + c  )
"madc.hi.cc.u32	%9, %15, %27, %9;\n\t"		//(O9 += r15 * s27.hi + c  )
"addc.cc.u32	%10, %15, %10;\n\t"		//(O10 += r15 + c)
"addc.cc.u32	%11, 0, %11;\n\t"		//(O11  + = +c)
"addc.cc.u32	%0, 0, %0;\n\t"		//(O0  + = +c)
"addc.cc.u32	%1, 0, %1;\n\t"		//(O1  + = +c)
"addc.cc.u32	%2, 0, %2;\n\t"		//(O2  + = +c)
...
"add.cc.u32	%7, %12, %7;\n\t"		//(O7 += r12)
"madc.lo.cc.u32	%8, %14, %28, %8;\n\t"		//(O8 += r14 * s28.lo + c  )
"madc.hi.cc.u32	%9, %14, %28, %9;\n\t"		//(O9 += r14 * s28.hi + c  )
"addc.cc.u32	%10, 0, %10;\n\t"		//(O10  + = +c)
"addc.cc.u32	%11, 0, %11;\n\t"		//(O11  + = +c)
"addc.cc.u32	%0, 0, %0;\n\t"		//(O0  + = +c)
"addc.cc.u32	%1, 0, %1;\n\t"		//(O1  + = +c)
...
"addc.u32	%4, 0, %4;\n\t"		//(O4 + = +c)
	...
	: "=r"(_q[4]), "=r"(_q[5]), "=r"(_q[6]), "=r"(_q[7]), "=r"(_q[8]), "=r"(tmp), "=r"(tmp1), "=r"(tmp2), "=r"(_q[0]), "=r"(_q[1]), "=r"(_q[2]), "=r"(_q[3])
